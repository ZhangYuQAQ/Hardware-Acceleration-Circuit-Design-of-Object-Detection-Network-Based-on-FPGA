...
void summernet(uint8 image_in_raw_pad[3][162][322],
...
#pragma HLS unroll
				...
				//load_bias_from_axi(bias_buf[0], bias_all[bias]);


//				if( ch_conv7 % 2 == 0) {
//					load_weight_3D_from_axi(weight_buf_3x3[0], conv_weight_3x3_all[weight_3x3]);
//					load_pool6_from_axi(FM_buf3, DDR_pool6_out_PL, ch_conv7, col, row);
//					set_bias(FM_buf2, bias_buf);
//					CONV_3x3_group(FM_buf3, FM_buf2, weight_buf_3x3[0]);
//					Relu(FM_buf2);
//					copy_to_DDR_pool6( DDR_pool6_out_PL, FM_buf2, ch_conv7, col, row);
//
//				}
//				else {
...
//					Relu(FM_buf4);
//					copy_to_DDR_pool6( DDR_pool6_out_PL, FM_buf4, ch_conv7, col, row);
//
//				}
